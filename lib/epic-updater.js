    ...
    if (client) {
      client.app.log({
        body: {
          service: 'powerlevel',
          level: 'info',
          message: `✅ Added journey entry to epic #${epicNumber}`
        }
      });
    }
  } catch (error) {
    if (client) {
      client.app.log({
        body: {
          service: 'powerlevel',
          level: 'error',
          message: `Error adding journey entry to epic #${epicNumber}: ${error.message}`
        }
      });
    }
    throw error;
      ...
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'warn',
            message: `⚠️  Epic auto-updates disabled in config`
          }
        });
      }
      return;
      ...
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'info',
            message: `ℹ️  Epic #${epicNumber} is already in sync`
          }
        });
      }
      return;
      ...
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'info',
            message: `✅ Synced epic #${epicNumber} to GitHub`
          }
        });
      }
    } catch (ghError) {
      ...
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'error',
            message: `⚠️  Network error syncing epic #${epicNumber}: ${error.message}\nEpic remains marked as dirty for retry`
          }
        });
      }
    } else {
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'error',
            message: `Error syncing epic #${epicNumber}: ${error.message}`
          }
        });
      }
      throw error;
      ...
      if (client) {
        client.app.log({
          body: {
            service: 'powerlevel',
            level: 'info',
            message: `✅ Added completion comment to epic #${epicNumber}`
          }
        });
      }
    }
    ...
    if (client) {
      client.app.log({
        body: {
          service: 'powerlevel',
          level: 'warn',
          message: `Warning: Could not add comment to epic #${epicNumber}: ${error.message}`
        }
      });
    }
  }
